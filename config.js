const ownerNumber = ["558897032731@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '558897032731' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=558897032731:+55 88 9703-2731\n' 
+ 'END:VCARD'
